...
import { FaUserPlus, FaCalendarPlus, FaEdit, FaBullhorn, FaCheckCircle, FaTrash, FaTimes } from 'react-icons/fa';
...
export default function NotificationDropdown({ isOpen, onClose, notifications, onMarkAsRead, onMarkAllAsRead }) {
  ...
  return (
    <div className="absolute top-14 right-0 w-80 bg-white rounded-2xl border border-orange-100 shadow-2xl z-50 overflow-hidden animate-scaleIn">
      ...
      <div className="p-3 border-t border-gray-50 text-center">
        <button className="text-xs font-bold text-gray-400 hover:text-indigo-600 transition-colors py-1">
